...
from basicsr.archs.lkasr_arch import LKASR
...
def main(args):
    ...
    # Set log file
    log_file = osp.join(args.log_path, args.model_name, f'DIV2K_val100_{get_time_str()}.log')
    logger = get_root_logger(logger_name='EfficientSR', log_level=logging.INFO, log_file=log_file)
    ...
    model = LKASR(n_feats=30, n_blocks=5, n_iters=3, upscaling_factor=4)#LKASR(n_feats=27, n_blocks=5, n_iters=3, upscaling_factor=4)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='IKA_bilinear', help='method name')
    parser.add_argument('--lr_path', type=str, default='datasets/DIV2K/DIV2K_Valid/LR_bicubic/X4', help='Path to the LR image')
    ...
    parser.add_argument('--pretrain_model', type=str, default='experiments/LKASR_b64f30n5i3_DIV2K_300k_x4_Decomp/models/net_g_latest.pth', help='Path to the pretrained model')
