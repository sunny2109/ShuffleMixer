...
from basicsr.archs.mobilesr_arch import MobileSR
from basicsr.archs.transsr_arch import TransSR
...
def main(args):
    ...
    model = TransSR(num_feat=32, num_block=5, res_ratio=2, mlp_ratio=4, upscaling_factor=4) #MobileSR()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='MobileSR', help='method name')
    parser.add_argument('--lr_path', type=str, default='/media/ubuntu/FC6C898C6C8941FE/Datasets/SISR/DIV2K/DIV2K_val_LR_bicubic/X4', help='Path to the LR image')
    ...
    parser.add_argument('--pretrain_model', type=str, default='experiments/MobileSRv3_x4_DF2K_c32n5_l1_lf/models/net_g_120000.pth', help='Path to the pretrained model')
