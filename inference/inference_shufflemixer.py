...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr_path', type=str, default='/media/sunlong/78C88475C8843402/PAN/datasets/test_img', help='Path to the LR image')
    ...
    parser.add_argument('--pretrain_model', type=str, default='experiments/net_g_latest.pth', help='Path to the pretrained model')
