...
def main(args):
    ...
    log_file = osp.join(args.log_path, f"{args.model_name}_Benchmarks_{get_time_str()}.log")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='IMDN_x2_Y_urban100_patches', help='method name')
    parser.add_argument('--gt', type=str, default='datasets/urban100_test/HR_patch', help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default='datasets/urban100_test/IMDN_patch', help='Path to restored images')
